...
public class LoginForm extends javax.swing.JPanel {
    ...
    private void login() {
        ...
        if (ten.isEmpty()) {
            ...
            try {
                String sql = "SELECT id_taiKHoan, vaiTro FROM taiKhoan WHERE tenDangNhap = ? AND matKhau = ?";
                ...
                if (rs.next()) {
                    ...
                    Application.login(idTaiKhoan, ten, vaiTro);
                } else {
    ...
    private class LoginLayout implements LayoutManager {
        ...
        public Dimension preferredLayoutSize(Container parent) {
            synchronized (parent.getTreeLock()) {
                ...
                height += UIScale.scale(buttonGap);
                height += btDK.getPreferredSize().height;
        ...
        public void layoutContainer(Container parent) {
            synchronized (parent.getTreeLock()) {
                ...
                btDK.setBounds(x, y + cmdLogin.getPreferredSize().height + UIScale.scale(buttonGap), width, btDK.getPreferredSize().height);
